...
class Model(object):
    ...
    def load_data(self):
        ...
        self.test_one,\
        self.test_two=self.get_P_N_data(data)
    ...
    def add_model(self):
        input_words,input_pos1,input_pos2=self.input_x,self.input_pos1,self.input_pos2
        ...
        with tf.variable_scope('Embeddings') as scope:
            ...
            word_embeddings=tf.concat([word_pad,word_embeddings],axis=0)
